...
/**
 * ClineLogoVariable component renders the Companion logo with automatic theme adaptation.
 *
 ...
 * @returns {JSX.Element} SVG Companion logo that adapts to VS Code themes
 */
