		...
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					...
					you understand what Companion did at a glance.
				</li>
				<li>
					<b>UX Improvements:</b> Type while Companion works, smarter auto-scrolling, new copy buttons for task headers
					and messages, and a simplified home interface for a smoother experience.
				</li>
				<li>
					<b>Commit Message Generation:</b> Let Companion help craft meaningful commit messages based on your changes.
				</li>
				<li>
			...
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						...
						<li>
							<b>Global Companion Rules:</b> Store multiple rules files in Documents/Cline/Rules to share between
							projects.
						</li>
						<li>
